...
public class OperationServiceTests
{
    ...
    public void GetStatics_ValidCripto_ReturnsCorrectStatistics()
    {
        ...
        mockRepository.Setup(r => r.GetLast(It.IsAny<string>())).Returns(entity);
        mockRepository.Setup(it => it.GetByTime("BTC" ,It.IsAny<decimal>())).Returns(new List<OrderBookEntity>()
        {
            new OrderBookEntity
            {
                asks = new List<PriceQuantityPairEntity>
